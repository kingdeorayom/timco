@extends('mainlayout')
@section('title', 'Privacy Policy | TOPSURE INDUSTRIAL MACHINERIES AND CONTROLS CORPORATION')
@section('content')
...
<section class="max-w-screen-xl px-5 py-12 mx-auto space-y-16">
    ...
    <div class="space-y-10">
        <h3 class="text-2xl font-bold">1. Information We Collect</h3>
        <div class="space-y-4">
        ...
        <h3 class="text-2xl font-bold">3. How We Share Your Information</h3>
        <div class="space-y-4">
            <p>We may use your information for the following purposes:</p>
            <ul class="list-disc px-10 space-y-4">
                <li>
        ...
        <h3 class="text-2xl font-bold">4. Data Security</h3>
        <div class="space-y-4">
            <p>
        ...
        <h3 class="text-2xl font-bold">5. Your Choices</h3>
        <div class="space-y-4">
