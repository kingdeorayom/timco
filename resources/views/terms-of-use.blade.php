@extends('mainlayout')
@section('title', 'Terms of Use | TOPSURE INDUSTRIAL MACHINERIES AND CONTROLS CORPORATION')
@section('content')
...
<section class="max-w-screen-xl px-5 py-12 mx-auto space-y-16">
    ...
    <div class="space-y-10">
        <h3 class="text-2xl font-bold">1. Use of the Website</h3>
        <div class="space-y-4">
            <p>
            ...
            <ul class="list-disc px-10 space-y-4">
                <li>
        ...
        <h3 class="text-2xl font-bold">2. Intellectual Property</h3>
        <div class="space-y-4">
            <p>
        ...
        <h3 class="text-2xl font-bold">3. Disclaimer of Warranties</h3>
        <div class="space-y-4">
            <p>
        ...
        <h3 class="text-2xl font-bold">4. Limitation of Liability</h3>
        <div class="space-y-4">
            <p>
        ...
        <h3 class="text-2xl font-bold">5. as to Third-Party Websites</h3>
        <div class="space-y-4">
            <p>
        ...
        <h3 class="text-2xl font-bold">6. Governing Law</h3>
        <div class="space-y-4">
            <p>
        ...
        <h3 class="text-2xl font-bold">7. Changes to these Terms</h3>
        <div class="space-y-4">
            <p>
        ...
        <div class="space-y-4">
            <p>
                ...
                <a href="/about#contact-us" class="text-blue-700 hover:underline">
                    here
                </a>
                .
            </p>
        </div>
        <h3 class="text-2xl font-bold">9. Entire Agreement</h3>
        <div class="space-y-4">
            <p>
        ...
        <h3 class="text-2xl font-bold">10. Severability</h3>
        <div class="space-y-4">
            <p>
