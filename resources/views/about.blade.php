@extends('mainlayout')
@section('title', 'Committed to Innovation, Precision, and Customer Satisfaction | TOPSURE INDUSTRIAL MACHINERIES AND CONTROLS CORPORATION')
@section('content')

<div class="max-w-screen-2xl px-5 py-12 mx-auto space-y-16">
  <section class="max-w-screen-xl mx-auto space-y-12 text-center">
    <div class="space-y-4">
      <h3 class="text-timco-red font-bold text-lg">
  ...
  <section class="px-5 pt-20 pb-16 mx-auto" id="company-history">
    <div class="grid lg:grid-cols-2 gap-4 lg:gap-10 xl:gap-16">
      ...
      <div class="space-y-8">
        <h2 class="text-5xl font-bold text-timco-dark-blue">
          A history of firsts that put
          <span class="text-timco-red">customers first</span>
        </h2>
        <p>
        ...
        <div class="space-y-10 py-4">
          <p class="border-l-4 border-dotted border-timco-dark-blue ps-8 xl:ps-10">
  ...
  <section class="space-y-16" id="mission-vision">
    <div class="grid lg:grid-cols-2 gap-4 lg:gap-10 xl:gap-16">
  ...
  <section
    class="max-w-screen-xl mx-auto py-16 space-y-12 text-center"
    id="meet-the-team">
    <div class="space-y-4">
      <h2 class="text-5xl font-bold text-timco-dark-blue">
        Driven by
        <span class="text-timco-red">innovation and excellence</span>, our
        founders have built a legacy of quality, dedication, and industry
        leadership.
      </h2>
    </div>
    <div class="grid md:grid-cols-2 gap-8 py-10">
      <div class="flex justify-center items-center flex-col space-y-16">
        <div class="bg-timco-white rounded-full h-48 w-48 md:h-64 md:w-64 border-2 border-slate-600" />
        <div class="text-center">
          <h3 class="font-bold text-xl text-timco-dark-blue">
            RONNEL MENDOZA
          </h3>
          <p class="text-timco-content text-lg">President</p>
        </div>
      </div>
      <div class="flex justify-center items-center flex-col space-y-16">
        <div class="bg-timco-white rounded-full h-48 w-48 md:h-64 md:w-64 border-2 border-slate-600" />
        <div class="text-center">
          ...
          <p class="text-timco-content text-lg">Vice President</p>
        </div>
      </div>
    </div>
    <p class="text-xl text-balance">
  ...
  <section
    id="contact-us"
    class="max-w-screen-xl mx-auto space-y-12 text-center">
    <div class="space-y-8">
      <h2 class="text-5xl font-bold text-timco-dark-blue">Contact Us</h2>
      <p class="text-xl text-balance">
    ...
    <div class="grid md:grid-cols-3 gap-8 py-8">
      <div
        id="business-address"
        class="p-6 pb-10 space-y-6 flex flex-col items-center bg-slate-50 hover:bg-slate-100 transition-all duration-300 ease-in-out rounded-2xl">
        <div class="h-14 w-14 flex items-center justify-center">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 384 512"
            class="h-7 w-7 fill-timco-dark-blue">
            <path d="M215.7 499.2C267 435 384 279.4 384 192C384 86 298 0 192 0S0 86 0 192c0 87.4 117 243 168.3 307.2c12.3 15.3 35.1 15.3 47.4 0zM192 128a64 64 0 1 1 0 128 64 64 0 1 1 0-128z" />
          </svg>
        </div>
        <h3 class="font-semibold text-lg">BUSINESS ADDRESS</h3>
        <p>
      ...
      <div
        ...
        <h3 class="font-semibold text-lg">LANDLINE NUMBER</h3>
        <p>775-34-92</p>
      ...
      <div
        ...
        <h3 class="font-semibold text-lg">MOBILE NUMBERS</h3>
        <p>
          +63 917 870 675 <br />
          +63 915 891 8418
        </p>
      ...
      <div
        ...
        <h3 class="font-semibold text-lg">E-MAIL ADDRESS</h3>
