  ...
  return (
    <section className="max-w-screen-xl px-5 py-12 mx-auto space-y-16">
      <div className="grid lg:grid-cols-2 gap-4 lg:gap-10 xl:gap-16">
        {/* <div className="grid lg:grid-cols-2 gap-8 md:flex md:flex-row-reverse"> */}
        <div className="space-y-8 py-8 md:order-last order-first">
          ...
          <p>
            ...
            craftsmanship and outstanding service. Our clients come from various
            industries, including manufacturing, construction, and engineering,
            all benefiting from our cost-effective and innovative solutions.
            Explore our valued partners and see why companies continue to choose
            TIMCO as their trusted provider.
          </p>
        </div>
