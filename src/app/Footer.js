    ...
    <footer className="bg-timco-white">
      <div className="max-w-screen-2xl px-6 mx-auto text-timco-content py-12 xl:py-16 space-y-8">
        <div className="grid lg:grid-cols-12 pb-8">
            ...
            <div className="flex space-x-6">
              ...
              >
                <svg
                  ...
                  viewBox="0 0 512 512"
                  className="h-7 w-7 fill-timco-slate hover:fill-timco-dark-blue"
                >
          ...
          <div className="col-span-9 lg:px-12 pt-8">
        ...
        <div className="flex xl:flex-row flex-col xl:items-center xl:justify-between md:pt-4 space-y-8 xl:space-y-0">
            ...
            <ul className="flex space-x-6 font-semibold">
              <li>
                <Link
                  ...
                  className="hover:text-timco-slate transition-all duration-300 ease-in-out text-sm sm:text-base"
                >
                  Accessibility
                </Link>
              </li>
